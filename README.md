...
## The regression model uses recursive feature elimination with cross-validation (RFECV) to select the best features for predicting solar panel power output (Power(MW) - as it was a machine learning practice i found quite interesating and wanted to see how i could incorporate it and if it makes any difference than using all the features directly.
